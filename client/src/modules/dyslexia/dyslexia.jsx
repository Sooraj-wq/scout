    ...
    <div className="max-w-4xl mx-auto p-8 my-8">
      ...
      <div className="flex justify-center gap-4 mb-10">
        <button
          ...
          className={`px-6 py-2 rounded-full transition-all duration-300 font-bold shadow-md
            ${activeMode === 'handwriting' 
              ? 'bg-gradient-to-r from-pink to-mauve text-white scale-105 ring-2 ring-pink/30' 
              : 'bg-surface0 text-subtext0 hover:bg-surface1 hover:text-text'}`}
        >
          {t('dyslexiaModeHandwriting')}
        </button>
        <button
          onClick={() => setActiveMode('reading')}
          className={`px-6 py-2 rounded-full transition-all duration-300 font-bold shadow-md
            ${activeMode === 'reading' 
              ? 'bg-gradient-to-r from-mauve to-blue text-white scale-105 ring-2 ring-blue/30' 
              : 'bg-surface0 text-subtext0 hover:bg-surface1 hover:text-text'}`}
        >
          {t('dyslexiaModeReading')}
        </button>
      </div>
